...
public class Activity13_2a {
    ...
    public void writeExcel(String filePath) throws IOException {
        ...
        String[] row1 = {"1","lakshmi","bhavani","lakshmi@gmail.com","9347526996"};
        String[]row2={"2","veepuri","bru","bru@metlife.com","9347526997"};
        String[]row3={"3","satya","deepu","satya@gmail.com","9347526998"};

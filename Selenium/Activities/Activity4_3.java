...
public class Activity4_3 {
    public static void main(String[] args) {
        ...
        String greyButtonClass = driver.findElement(By.xpath("/html/body/div/div[2]/div/div[2]/div/div/div/div[2]/div[3]/button[2]")).getText();
        System.out.println("Grey button's classes are: " + greyButtonClass);
